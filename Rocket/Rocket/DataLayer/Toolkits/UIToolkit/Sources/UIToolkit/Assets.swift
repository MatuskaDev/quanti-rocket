...
public enum Asset {
  ...
  public enum Images {
    public static let burn = ImageAsset(name: "Burn")
    public static let engine = ImageAsset(name: "Engine")
    public static let fuel = ImageAsset(name: "Fuel")
    public static let reusable = ImageAsset(name: "Reusable")
    public static let rocketFlying = ImageAsset(name: "Rocket Flying")
    public static let rocketIdle = ImageAsset(name: "Rocket Idle")
    public static let rocket = ImageAsset(name: "Rocket")
    public static let rocketError = ImageAsset(name: "rocketError")
  }
}
